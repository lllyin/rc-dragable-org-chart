...
function CombinedNodes(props) {
  ...
  }))), /*#__PURE__*/React__default['default'].createElement(SvgArrowIcon, {
...
function Node(props) {
  ...
  var _useState = React.useState(nodeTransform),
  ...
  }, renderContent(data, data[levelKey], colNum), collapsable && data.children && data.children.length > 0 && /*#__PURE__*/React__default['default'].createElement("div", {
...
var renderChildren = function renderChildren(children, props, colNum) {
  ...
  }), isAllNull ? null : /*#__PURE__*/React__default['default'].createElement(SvgArrowIcon, {
    className: cls('arrow-icon')
  }))];

  if (combinedNodes.length === (children === null || children === void 0 ? void 0 : children.length)) {
    childEles = [/*#__PURE__*/React__default['default'].createElement(CombinedNodes, {
      nodes: combinedNodes,
      extraProps: props,
      colNum: colNum
    })];
  } else if (combinedNodes.length > 0) {
    childEles.push( /*#__PURE__*/React__default['default'].createElement(CombinedNodes, {
      nodes: combinedNodes,
      extraProps: props,
      colNum: colNum
    }));
...
function SvgZoomInIcon(props) {
  return /*#__PURE__*/React.createElement("svg", _extends$2({
    ...
    width: 200,
    height: 200
  }, props), _defs$2 || (_defs$2 = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("style", null))), _path$2 || (_path$2 = /*#__PURE__*/React.createElement("path", {
    d: "M309.894 485.053h404.211q40.421 0 40.421 40.42 0 40.422-40.42 40.422H309.894q-40.421 0-40.421-40.421t40.42-40.421z",
    fill: "#666"
...
function DragableContainer(props, ref) {
  ...
  var _useState3 = React.useState(defaultStyles),
      _useState4 = _slicedToArray(_useState3, 2),
      styles = _useState4[0],
      _setStyles = _useState4[1];

  var stylesRef = React.useRef(defaultStyles);
...
function OrgTree(props) {
  ...
  var dragContainerRef = React.useRef(null);
  ...
  return /*#__PURE__*/React__default['default'].createElement(DragableContainer$1, {
